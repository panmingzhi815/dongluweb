...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults.column = {
		 ...
		 *      comma-space separated rows from the source array. If no characters
		 ...
		 *
		 *  @example
		 *    // Using array notation - outputting a rows from an array
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "columnDefs": [ {
		 *          "targets": [ 0 ],
		 ...
		 *
		 *  @example
		 *    // Create a comma separated rows from an array of objects
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajaxSource": "sources/deep.txt",
		 *        "columns": [
