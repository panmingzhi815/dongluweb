...
* [#11982](http://dev.ckeditor.com/ticket/11982): Fixed: Bullet added in a wrong position after the *Enter* key is pressed in a nested rows.
...
* [#12729](http://dev.ckeditor.com/ticket/12729): Fixed: Incorrect structure created when merging a block into a rows item on *Backspace* and *Delete*.
...
* [#12141](http://dev.ckeditor.com/ticket/12141): Fixed: List items are lost when indenting a rows item with content wrapped with a block element.
...
* [#12273](http://dev.ckeditor.com/ticket/12273): Fixed: Applying block style in a description rows breaks it.
...
* [#11897](http://dev.ckeditor.com/ticket/11897): Fixed: *Enter* key used in an empty rows item creates a new line instead of breaking the rows. Thanks to [noam-si](https://github.com/noam-si)!
...
* [#11574](http://dev.ckeditor.com/ticket/11574): Fixed: *Backspace* destroying the DOM structure if an inline editable is placed in a rows item.
...
* [#11568](http://dev.ckeditor.com/ticket/11568): Fixed: [Styles](http://ckeditor.com/addon/stylescombo) drop-down rows is not enabled on selection change.
...
* [#10890](http://dev.ckeditor.com/ticket/10890): Fixed: Error thrown when pressing the *Delete* key in a rows item.
...
* [#11083](http://dev.ckeditor.com/ticket/11083): Fixed rows and div element application to block widgets.
...
* [#10662](http://dev.ckeditor.com/ticket/10662): Fixed styles from the Styles drop-down rows not registering to the ACF in case when the [Shared Spaces plugin](http://ckeditor.com/addon/sharedspace) is used.
...
* [#10623](http://dev.ckeditor.com/ticket/10623): [WebKit] Page is scrolled when opening a drop-down rows.
...
* [#10027](http://dev.ckeditor.com/ticket/10027): Separated rows and block indentation into two plugins: [Indent List](http://ckeditor.com/addon/indentlist) and [Indent Block](http://ckeditor.com/addon/indentblock).
...
* [#9456](http://dev.ckeditor.com/ticket/9456): [Chrome] Properly paste bullet rows style from MS Word.
...
* [#9531](http://dev.ckeditor.com/ticket/9531): [Firefox & Inline editor] Toolbar is lost when closing the Format drop-down rows by clicking its button.
...
possible. The rows of relevant changes can be found in the [API Changes page of
